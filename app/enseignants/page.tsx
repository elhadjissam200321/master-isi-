...
const teachers = [
  { name: "Pr. DEHBI RACHID", title: "Professeur de l'Enseignement Supérieur", role: "Enseignant-chercheur", speciality: "Bases de Données, Big Data", color: "bg-primary", isCoordinator: true },
  ...
  { name: "Pr. ERRAIS MOHAMMED", title: "Professeur de l'Enseignement Supérieur", role: "Enseignant-chercheur", speciality: "IoT, Cloud Computing", color: "bg-primary" },
